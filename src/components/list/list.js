...
class List {
  ...
  updateProject(projectId) {
    ...
    firebase.database().ref(this._ref).child(`${firebase.auth().currentUser.uid}/${projectId}`).remove()
      .then(() => {
  ...
  deleteProject(project) {
    ...
    firebase.database().ref(this._ref).child(`${firebase.auth().currentUser.uid}/${project._id}`).remove()
      .then(() => {
